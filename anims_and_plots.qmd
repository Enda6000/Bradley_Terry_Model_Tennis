...
As part of k-fold cross validation we pick a different training set and test set at each fold. We check to see what probability we assigned to the actual winner of each game in the test set. Here we see how well our model assigned probabilities to the winner in each hold-out set. This is the essence of what log loss captures as a performance metric, how confident were we in our prediction? The plot here indicates what probabilities we assigned to the actual winner.
